...
func main() {
	...
	// 测试数据 - 创建极长的内容来强制触发分页
	baseContent := `阅读是一项重要的技能，它不仅能够丰富我们的知识，还能提升我们的思维能力、语言表达能力和情感体验。阅读对个人成长有着深远的影响。首先，它有助于扩展知识面。通过阅读不同类型的书籍，我们可以接触到各种各样的思想和观点，这有助于我们形成更加全面的世界观。例如，阅读历史书籍可以帮助我们了解过去发生的事件及其影响，而阅读科学类书籍则能让我们掌握最新的研究成果和技术发展。此外，阅读还可以提高我们的学习能力。当我们阅读时，大脑需要不断处理和分析信息，这种过程可以锻炼我们的逻辑思维能力和记忆力。阅读对个人成长有着深远的影响。`

	// 重复更多次来创建极长内容，确保超过1320px
	testMarkdown := ""
	for i := 0; i < 15; i++ {
		testMarkdown += baseContent + "\n"
	}
