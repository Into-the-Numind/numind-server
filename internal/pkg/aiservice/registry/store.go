...
type IStore interface {
	...
	// Results are ordered by priority DESC (higher number = higher priority = tried first).
...
// when role is non-empty. Results are ordered by priority DESC (higher number = higher priority = tried first).
