...
type PaymentM struct {
	...
	SubscriptionType string    `json:"subscription_type" gorm:"type:varchar(20);comment:订阅类型(monthly,yearly)"`
...
type CreatePaymentRequest struct {
	...
	SubscriptionType string `json:"subscription_type,omitempty"`                                   // 订阅类型（仅当membership_type为subscription时使用）
