...
func TestCreateOrder_Booster_ParentProxyPurchase(t *testing.T) {
	...
	parentID := mustCreateUser(t, db, model.UserTierStandard, model.BillingModeCredits, nil)
	childID := mustCreateUser(t, db, model.UserTierStandard, model.BillingModeCredits, nil)
...
func TestCreateOrder_Booster_ActiveTrialMember_Passes(t *testing.T) {
	...
	uid := mustCreateUser(t, db, model.UserTierTrial, model.BillingModeCredits, nil)
