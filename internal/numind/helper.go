...
func autoMigrate(db *gorm.DB) error {
	...
	if err := db.AutoMigrate(&model.UsageRecord{}, &model.BillingAccount{}, &model.PricingRule{}, &model.CreditAccount{}, &model.CreditPackage{}, &model.CreditTransaction{}); err != nil {
