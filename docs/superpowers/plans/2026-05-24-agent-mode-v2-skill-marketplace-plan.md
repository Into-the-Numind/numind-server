...
- ~~`migrations/20260524_120200_skill_add_subscribed_source_type.sql`~~ (superseded — 见 [ADR 0002](../../../.ndf/decisions/agent-mode-v2-skill-marketplace/0002-source-type-imported-from-marketplace.md)，#1 已预留 enum 第 4 值，不需要新 migration)
- ~~`migrations/20260524_120200_skill_add_subscribed_source_type.rollback.sql`~~ (同上 superseded)
