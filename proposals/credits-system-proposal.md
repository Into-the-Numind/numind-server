...
- 预估工作量：**18-23 天**（AI 辅助开发，跨 3 仓库；基于 S2 Section 3 + Section 4 review 逐步修正：控制流反转 + pricing 模块 + 前端 402 拦截器 + estimate 聚合口径 + MigrationsView 状态机）
- 交付时间线：**2026-05-16 前上线 dev 环境**（12-15→14-18→18-23 两次上调，分别顺延 3+5 天）
