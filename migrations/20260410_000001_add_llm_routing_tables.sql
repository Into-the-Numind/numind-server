-- LLM 模型切换与多供应商路由表
-- ROLLBACK:
-- DROP TABLE IF EXISTS llm_model_provider;
...
INSERT IGNORE INTO llm_model (model_key, display_name, is_thinking, base_model_id, supports_thinking, icon, sort_order) VALUES
...
-- Thinking 变体（使用独立 UPDATE 避免 MySQL 同表子查询限制 Error 1093）
INSERT IGNORE INTO llm_model (model_key, display_name, is_thinking, base_model_id, supports_thinking, icon, sort_order) VALUES
