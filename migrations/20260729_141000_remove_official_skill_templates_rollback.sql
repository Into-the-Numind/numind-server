-- Rollback: restore the 10 built-in skill templates removed by
-- 20260729_141000_remove_official_skill_templates.sql.
--
-- Security note: this rollback intentionally does NOT promote tenant-owned
-- imported skills back to visibility='official', because doing so would
-- reintroduce cross-institution visibility leakage.
...
ON DUPLICATE KEY UPDATE
  ...
  default_tool_flags = VALUES(default_tool_flags),
